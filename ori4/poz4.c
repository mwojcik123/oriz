...
int main() {
    ...
    unsigned parent_pid = 12345; // symulowany pid procesu nadrzędnego
    unsigned child_pid = 12346;  // symulowany pid procesu potomka
    void *semaphore_address = (void *)0x7f8c0c0008e0; // symulowany adres semafora
